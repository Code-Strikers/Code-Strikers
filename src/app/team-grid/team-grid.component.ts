...
export class TeamGridComponent implements OnInit {
  persons = [
    ...
    {rows: 2, name: 'Constantin', role: 'Relations Internationales', citation: 'La part de non STI du groupe'},
    {rows: 1, name: 'Guillaume', role: 'Backend Developer', citation: ''},
    {rows: 2, name: 'Louis', role: 'Frontend Developer', citation: 'L\'avenir appartient à ceux qui ne dorment pas'},
    ...
    {rows: 1, name: 'Camille', role: 'Backend Developer', citation: ''}
  ];
